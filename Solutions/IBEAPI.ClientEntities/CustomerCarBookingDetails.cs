...
namespace IBEAPI.ClientEntities
{
    ...
    public class Datum
    {
        public string reservNum { get; set; }
        ...
        public PickUpBranch pickUpBranch { get; set; }
        public string pickUpBranchLine { get; set; }
        public DropOffBranch dropOffBranch { get; set; }
