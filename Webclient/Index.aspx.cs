                                ...
                                if (offers[0].ToLower().Contains("giftcards"))
                                {
                                    ...
                                    if (searchResult != null && searchResult.Products != null && searchResult.Products.Count > 0)
                                    {
                                        ...
                                        {                                          
                                            ...
                                            sb.Append(string.Format("<div class=\"swiper-slide shadow-sm\"><div class=\"dvProductCard\"><div class=\"dvItem\"><a class=\"anchor\" href=\"ProductDetails.aspx?ProductId={4}&ProductType={2}\"><div class=\"img-container\"><img src=\"{0}\"  alt=\"\" /></div><h2 >{1}</h2><div class=\"d-flex flex-wrap justify-content-between\"><p class=\"points\">{3}</p><p class=\"points\">{2}</p></div></a></div></div></div>", product.PrimaryImage.Url, product.Name, pstrProductType, lobjModel.FormatPoints(Math.Ceiling(product.Price.SalePriceWithTax.Amount), "Points"), product.Id));                                            
                                        }
