                ...
                if (lobjOrders.CustomerOrders != null && lobjOrders.CustomerOrders.Count > 0)
                {
                    ...
                    for (int i = 0; i < lobjOrders.CustomerOrders.Count; i++)
                    {
                        lstrHtmlContent += "<div class=\"row mb-1\"><div class=\"col-12\"><div class=\"bg-white p-3\">"
                                ...
                                + "<div class=\"col-12 col-sm-6 col-lg-2 mb-1\"><p><span class=\"h7 d-block heading-semibold\">Order No.</span> <span class=\"h6 d-block\">" + lobjOrders.CustomerOrders[i].Number + "</span></p></div>"
                                + "<div class=\"col-12 col-sm-6 col-lg-3 mb-1\"><p><span class=\"h7 d-block heading-semibold\">Order Date</span><span class=\"h6 d-block\">" + DateTime.Parse(lobjOrders.CustomerOrders[i].CreatedDate.ToString()).ToLocalTime() + "</span></p></div>"
                                + "<div class=\"col-12 col-lg-2 col-sm-6 mb-1\"><p class=\"heading-semibold\"><span class=\"h6 d-inline-block heading-semibold\">" + lobjModel.FormatPoints(Math.Ceiling(lobjOrders.CustomerOrders[i].Price.Total.Amount), "NPoints") + "</span></p></div>"
                                + "<div class=\"col-6 col-lg-1 col-sm-3 mb-1\"><p><span class=\"h7 d-inline-block heading-semibold pr-2\">Qty:</span><span class=\"h6 d-inline-block\">" + lobjOrders.CustomerOrders[i].Items.Count + "</span></p></div>"
