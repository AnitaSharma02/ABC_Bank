                ...
                if (lobjOrders.CustomerOrders != null && lobjOrders.CustomerOrders.Count > 0)
                {
                    ...
                    for (int i = 0; i < lobjOrders.CustomerOrders.Count; i++)
                    {
                        lstrHtmlContent += "<div class=\"row mb-1\"><div class=\"col-12\"><div class=\"bg-white p-3\">"
                                ...
                                + "<div class=\"col-12 col-lg-2 col-sm-6 mb-1\"><p class=\"heading-semibold\"><span class=\"h6 d-inline-block heading-semibold\">" + lobjModel.FormatPoints(Math.Ceiling(lobjOrders.CustomerOrders[i].Price.Total.Amount), "Points") + "</span></p></div>"
