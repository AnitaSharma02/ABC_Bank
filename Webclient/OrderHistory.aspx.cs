                ...
                if (lobjOrders.CustomerOrders != null && lobjOrders.CustomerOrders.Count > 0)
                {
                    ...
                    for (int i = 0; i < lobjOrders.CustomerOrders.Count; i++)
                    {
                        lstrHtmlContent += "<div class=\"row mb-1\"><div class=\"col-12\"><div class=\"bg-white p-3\">"
                                ...
                                + "<div class=\"col-6 col-lg-1 col-sm-3 mb-1\"><p><span class=\"h7 d-inline-block heading-bold text-colour7 pr-2\">Qty:</span><span class=\"h6 d-inline-block\">" + lobjOrders.CustomerOrders[i].Items.Count + "</span></p></div>"
