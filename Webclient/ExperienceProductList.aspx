            ...
            if (data != '') {
                ...
                if (parseData != null && parseData.length > 0) {
                    for (var i = 0; i < parseData.length; i++) {
                        ...
                        html += '<p class="points"><span>from</span> <span>' + FormatCurrency(parseFloat(parseData[i].convertedAmount).toFixed(2), parseData[i].convertedCurrency) + '</span> <span>/pax</span></p>';
                        html += '</div>';
