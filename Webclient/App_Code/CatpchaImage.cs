...
public class CatpchaImage
{
    ...
    public void DrawText(string aText)
    {
        ...
        Font f = new Font("Calibri", startsize, FontStyle.Bold, GraphicsUnit.Pixel);

        do
        {
            f = new Font("Calibri", startsize, GraphicsUnit.Pixel);
            startsize--;
        ...
        g.FillRectangle(new System.Drawing.Drawing2D.LinearGradientBrush(rect, Color.FromArgb(1, 56, 149), Color.FromArgb(1, 56, 149), 0f), rect);
        g.SmoothingMode = SmoothingMode.HighQuality;


        Color noiseCol = Color.FromArgb(1, 56, 149);
        ...
        {
            g.FillEllipse(Brushes.WhiteSmoke, rnd.Next(0, Width), rnd.Next(0, Height), 1, 1);
        }
        /*noise ends here*/
