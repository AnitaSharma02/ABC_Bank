                ...
                else
                {
                    if (lobjorder.Status == "Placed" || lobjorder.Status.ToLower().Equals("completed"))
                    {
                        ...
                        lstrHtmlContent += "<tr style=\"text-align:right\">"
                                        ...
                                        + "<td style = \"background-color:#dde2e6; padding:0.6em 0.4 em\"><strong>" + lobjModel.FormatPoints(Math.Ceiling(Order.Price.ShippingTotal.Amount), "NPoints") + "</strong></td>"
                                        + "</tr>"

                                        + "<tr style=\"text-align:right\">"
                                        + "<td></td>"
                                        + "<td colspan = \"2\" style=\"background-color:#dde2e6; padding:0.6em 0.4 em\"><strong>Tax:</strong></td>"
                                        + "<td style=\"background-color:#dde2e6; padding:0.6em 0.4 em\"><strong>" + lobjModel.FormatPoints(Math.Ceiling(Order.Price.TaxTotal.Amount), "NPoints") + "</strong></td>"
                                        + "</tr>"
