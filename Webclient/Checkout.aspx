                 ...
                 <div class="col-lg-7">
                        <div class="row">
                            ...
                            <div class="col-12">
                                 ...
                                 <form class="needs-validation" novalidate>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="invalid-feedback" data-i18n="shopcheckout-validcountry">
                                ...
                                <div id="divCheckoutDigital" runat="server" class="bg-light">
                                    <hr class="mb-4">
                                    <button class="purple-btn btn-block text-uppercase" onclick="var varReturn = CheckoutDigital(); event.returnValue = varReturn; (event.preventDefault) ? event.preventDefault() : event.returnValue = false; return varReturn;">Continue to checkout</button>
                                </div>
                            </div>
                      </div>
                </div>
