...
public partial class Login : Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            LoggingAdapter.WriteLog("Login.aspx Page_Load Ex-" + ex.Message + ex.InnerException + ex.StackTrace);
        }
    }
    ...
    private static void updateSessionId(HttpContext Context)
    {
        ...
        {
            LoggingAdapter.WriteLog("Login.aspx- updateSessionId Ex: " + ex.Message + Environment.NewLine + ex.InnerException + Environment.NewLine + ex.StackTrace);
        }
    }
            ...
            if (lobjMemberDetails != null)
            {
                ...
                if (true)
                {
                    ...
                    if (lobjMemberRelations.WebPassword != strMD5Password.ToUpper())
                    {
                        ...
                        Session["MemberLocalAttrDetails"] = null;
                    }
                    if (lobjMemberDetails != null)
                    {
                    ...
                    if (lobjMemberDetails != null)
                    {
                        ...
                        if (pboolRememberMe)
                        {
                            HttpCookie cookie = new HttpCookie("NICLogin");
                        ...
                        if (lobjMemberRelation.Status.Equals(Status.Active) && lobjMemberRelation.IsAccountActivated)
                        {
                            ...
                            else if (HttpContext.Current.Session["MemberDetails"] != null)
                            {
                                ...
                                {
                                    CallbackUrl = Decrypt(Request.QueryString["CallbackUrl"]);
                                }
