        ...
        <div class="container-lg">
            <nav>
                <ul class="breadcrumb px-0 py-4">
                    ...
                    <li class="breadcrumb-item active" data-i18n="bread-statement">Statement Summary</li>
                </ul>
            </nav>
        </div>
    </div>
            ...
            <div class="row">
                <div class="dvEarned col-12 mb-4">
                    <div class="bg-lightgray py-2 rounded">
                        ...
                        <h5 id="my_account_poin_summary_earned" data-i18n="ss-earned-points" class="d-inline-block h6 heading-bold">Earned NPoints</h5>
                    </div>
                    <div class="d-flex flex-wrap">
                        <div class="col-6 border-bottom border-right border-left py-3">
                            <p data-i18n="ss-bonus-points" class="heading-regular">Bonus NPoints</p>
                        </div>
                    ...
                    <div class="d-flex flex-wrap">
                        <div class="col-6 border-bottom border-right border-left py-3">
                            <p id="my_account_poin_summary_spend" data-i18n="ss-on-spend-points" class="heading-regular">On Spend NPoints</p>
                        </div>
                        <div class="col-6 border-bottom border-right py-3">
                    ...
                    <div class="d-none flex-wrap">
                        <div class="col-6 border-bottom border-right border-left py-3">
                            <p id="my_account_poin_summary_purchase" data-i18n="ss-purchase-points" class="heading-regular">Purchase NPoints</p>
                        </div>
                        <div class="col-6 border-bottom border-right py-3">
                ...
                <div class="dvRedeemed col-12 mb-4">
                    <div class="bg-lightgray py-2 rounded">
                        ...
                        <h5 id="my_account_poin_summary_redeemed" data-i18n="ss-redeemed-points" class="d-inline-block h6 heading-bold">Redeemed NPoints</h5>
                    </div>
                    <div class="d-flex flex-wrap">
                        <div class="col-6 border-bottom border-right border-left py-3">
                            <p class="heading-regular" data-i18n="ss-points">NPoints</p>
                        </div>
                        <div class="col-6 border-bottom border-right py-3">
                ...
                <div class="dvExpired col-12 mb-4 d-none">
                    <div class="bg-lightgray py-2 rounded">
                        <img class="d-inline-block pl-2 pr-1 pl-sm-3 pr-sm-2" src="/images/icons/other/minus.svg" />
                        <h5 data-i18n="ss-expired-points" class="d-inline-block heading-bold">Expired NPoints</h5>
                    </div>
                    <div class="d-flex flex-wrap">
                        <div class="col-6 border-bottom border-right border-left py-3">
                            <p class="heading-regular" data-i18n="ss-points">NPoints</p>
                ...
                <div class="dvBalance col-12">
                    <div class="bg-primary py-2 rounded d-flex flex-wrap justify-content-between align-items-center">
                        <div>
                            ...
                            <h5 class="d-inline-block h6 heading-bold text-white" data-i18n="ss-points-balance">NPoints Balance</h5>
                        </div>
