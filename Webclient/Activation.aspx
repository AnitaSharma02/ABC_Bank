                    ...
                    <div class="border bg-colour2 p-4">
                        <div class="row">
                            <div class="col-12 mb-2">
                                <h2 class="h5 heading-semibold text-colour7 mb-1">Activation</h2>
                            </div>
                                            ...
                                            <div class="d-flex flex-wrap justify-content-between">
                                                <div>
                                                    <asp:LinkButton ID="FormLinkLogin" CausesValidation="false" runat="server"
                                                        ...
                                                        CssClass="heading-semibold link1">Back to Login</asp:LinkButton>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div id="divActivationOTP" style="display: none;">
                                    <div class="row">
                                        <div class="col-12 mb-3">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label class="h6 heading-semibold text-colour7">ID</label>
                                          ...
                                          <%--              <div id="captcha-container"></div>
                                                ...
                                                <div class="col-12">
                                                    <asp:Button ID="BtnActivationValidation" runat="server" CssClass="btn btn-one w-100" OnClick="BtnActivationValidation_Click" Text="Continue" OnClientClick="if (!ActivationValidationCodeBehind()) { return false;};" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
