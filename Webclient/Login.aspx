                    ...
                    <div class="innerBox p-4">
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                <h5 class="h6 heading-regular" id="loginHeader" data-i18n="text-all-fields-mandatory">All fields are mandatory.</h5>
                            </div>
                                    ...
                                    <div class="col-12 mb-3 valignM dvLabel">
                                        <label class="checkbox-container d-flex">
                                            <span class="d-inline-block ml-1">
                                                ...
                                                <span data-i18n="text-remember-this-computer" class="h6 heading-regular text-colour7">Remember me on this computer.</span>
                                                <span class="checkmark"></span>
                                            </span>
                                        </label>
                                    </div>
                                    <div class="col-12 mb-3">
                                        <asp:Button ID="BtnLoginValidation" data-i18n="[value]btn-continue" runat="server" CssClass="btn btn-one w-100" OnClick="BtnLoginValidation_Click"
