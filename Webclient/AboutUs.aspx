                    ...
                    <div class="accordion" id="static-accordion">
                        ...
                        <div class="card mb-3">
                            ...
                            <div id="collapse2" class="collapse" data-parent="#static-accordion">
                                <div class="card-body">
                                    <ul>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Car rental is available in 150,000 of our car rental partners around the world.</li>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Immediate booking and confirmation.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-3">
                            ...
                            <div id="collapse3" class="collapse" data-parent="#static-accordion">
                                <div class="card-body">
                                    <ul>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Through the online store you can access thousands of products and appliances from electronics, books, sports supplies, and household items.</li>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Immediate booking and confirmation.</li>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">You can shop online and see all products at any time.</li>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Choose from thousands of products for international brands such as apple, sony, samsung, toshiba and others.</li>
                                        <li class="h6 mb-3 heading-regular text-colour7 mx-3">Products will be delivered to your home anywhere in Nigeria.</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
