...
var inputFieldTemplate = function (type) {
  return {
    'template': '<input type="' + type + '" ' +
      ...
      '<%= (node.schemaElement.placeholder? " placeholder=" + \'"\' + escape(node.schemaElement.placeholder) + \'"\' : "")%>' +
      ' />',
    'fieldtemplate': true,
    'inputfield': true
  }
...
jsonform.elementTypes = {
  ...
  'submit':{
    'template':'<input type="submit" <% if (id) { %> id="<%= id %>" <% } %> class="btn btn-one <%= elt.htmlClass?elt.htmlClass:"" %>" value="<%= value || node.title %>"<%= (node.disabled? " disabled" : "")%>/>'
  },
  'button':{
