    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (icount = 0; icount < HotelNextList.length; icount++) {
                HotelList += '<div class="col-6 col-md-4 mb-4"><a class="d-block shadow-sm h-100" onclick="return getHotelDetails(' + HotelNextList[icount].hotelid + ')"><div class="bg-white border h-100 d-flex flex-column"><div class="img-container"><img onError="this.onerror=null;this.src=&quot;images/no-image.png&quot;" src="' + HotelNextList[icount].basicinfo.thumbnailimage + '" /></div><div class="d-flex flex-wrap bg-white p-2"><h2 class="h6 heading-semibold order-0 text-capitalize mb-2 col-12">' + HotelNextList[icount].basicinfo.hotelname + '</h2><h2 class="h6 heading-regular col-6 order-1 mt-auto AmtStylePoint">' + HotelNextList[icount].roomrates.RoomRate[0].ratebreakdown.rate[0].RatePoint + ' NPoints </h2><h2 class="h6 heading-regular col-6 order-2 mt-auto text-right"></h2><div class="rating order-3 mt-2 col-12 pl-0">'
    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (icount = 0; icount < HotelResponse[0].roomrates.RoomRate.length; icount++) {
                ...
                rptRoom += "<div class='row justify-content-between'><div class='col-12 col-md-6 col-lg-5 col-xl-6 mb-2 mb-md-0'><h2 class='h6 heading-regular text-colour7'>" + HotelResponse[0].roomrates.RoomRate[icount].roomtype.roomdescription + " (inclusive of all taxes)</h2></div><div class='col-6 col-sm-4 col-md-2 col-lg-3 col-xl-2 mb-3 mb-sm-0'><span class='d-inline-block h6 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[icount].ratebreakdown.rate[0].RatePoint + " <span class='d-inline-block h7 heading-semibold text-colour7'>NPoints</span></span><span class='d-inline-block h7 heading-semibold text-colour7'>  (per room per night)</span></div>";
                rptRoom += "<div class='col-6 col-sm-4 col-md-2 mb-3 mb-sm-0'><span class='d-inline-block h6 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[icount].TotalPoints + " <span class='d-inline-block h7 heading-semibold text-colour7'>NPoints</span></span><span class='d-inline-block h7 heading-semibold text-colour7'> for " + msg.d[1] + " night(s)</span></div>";
            ...
            $("#minrate").html("<span class='h3 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[0].TotalPoints + "</span><span class='h6 heading-semibold text-colour7'> NPoints</span> <span class='h6 heading-semibold text-colour7'>(for " + msg.d[1] + " night(s))</span>");
