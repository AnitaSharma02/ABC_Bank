    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (icount = 0; icount < HotelResponse[0].roomrates.RoomRate.length; icount++) {
                ...
                rptRoom += "<div class='row justify-content-between'><div class='col-12 col-md-6 col-lg-5 col-xl-6 mb-2 mb-md-0'><h2 class='h6 heading-regular text-colour7'>" + HotelResponse[0].roomrates.RoomRate[icount].roomtype.roomdescription + " (inclusive of all taxes)</h2></div><div class='col-6 col-sm-4 col-md-2 col-lg-3 col-xl-2 mb-3 mb-sm-0'><span class='d-inline-block h6 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[icount].ratebreakdown.rate[0].RatePoint + " <span class='d-inline-block h7 heading-semibold text-colour7'>Points</span></span><span class='d-inline-block h7 heading-semibold text-colour7'>  (per room per night)</span></div>";
                rptRoom += "<div class='col-6 col-sm-4 col-md-2 mb-3 mb-sm-0'><span class='d-inline-block h6 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[icount].TotalPoints + " <span class='d-inline-block h7 heading-semibold text-colour7'>Points</span></span><span class='d-inline-block h7 heading-semibold text-colour7'> for " + msg.d[1] + " night(s)</span></div>";
            ...
            $("#minrate").html("<span class='h3 heading-semibold text-colour7 totalPointValue'>" + HotelResponse[0].roomrates.RoomRate[0].TotalPoints + "</span><span class='h6 heading-semibold text-colour7'> Points</span> <span class='h6 heading-semibold text-colour7'>(for " + msg.d[1] + " night(s))</span>");
