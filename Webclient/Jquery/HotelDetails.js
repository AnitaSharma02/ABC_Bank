    ...
    $.ajax({
        ...
        success: function (msg) {
            ...
            for (icount = 0; icount < HotelNextList.length; icount++) {
                HotelList += '<div class="col-6 col-md-4 mb-4"><a class="d-block shadow-sm h-100" onclick="return getHotelDetails(' + HotelNextList[icount].hotelid + ')"><div class="bg-white border h-100 d-flex flex-column"><div class="img-container"><img onError="this.onerror=null;this.src=&quot;images/no-image.png&quot;" src="' + HotelNextList[icount].basicinfo.thumbnailimage + '" /></div><div class="bg-white d-flex flex-column p-2"><p class="h6 heading-semibold text-colour7 order-0 text-capitalize mb-2">' + HotelNextList[icount].basicinfo.hotelname + '</p><p class="h6 heading-regular text-colour7 order-1 mt-auto AmtStylePoint">' + HotelNextList[icount].roomrates.RoomRate[0].ratebreakdown.rate[0].RatePoint + ' Points </p><p class="h6 heading-regular text-colour7 order-2 mt-auto text-right"></p><div class="rating order-3 mt-2">'
