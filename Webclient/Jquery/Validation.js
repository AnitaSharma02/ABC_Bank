...
$(document).ready(function () {
    ...
    if (PageName == 'StatementSummary.aspx' || PageName == 'TransactionSummary.aspx' || PageName == 'PointsExpiry.aspx' || PageName == 'ManageBooking.aspx' || PageName == 'ViewMemberProfile.aspx' || PageName == 'PurchaseEarser.aspx' || PageName == 'PointsPurchase.aspx' || PageName == 'OrderHistory.aspx' || PageName == 'OrderHistory.aspx' || PageName == "OrderDetails.aspx") {
        var html = '<div class="col-6 col-lg-2 pe-0 pe-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divStatementSummary" href="StatementSummary.aspx">Statement <br class="d-none d-lg-block" />Summary</a></div>';
        html += '<div class="col-6 col-lg-2 ps-0 ps-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divTransactionSummary" href="TransactionSummary.aspx">Transaction <br class="d-none d-lg-block" />Summary</a></div>';
        html += '<div class="col-6 col-lg-2 pe-0 pe-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divPointexp" href="PointsExpiry.aspx">Points <br class="d-none d-lg-block" />Expiry</a></div>';
        html += '<div class="col-6 col-lg-2 ps-0 ps-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divManagebooking" href="ManageBooking.aspx">Manage <br class="d-none d-lg-block" />Booking</a></div>';
        html += '<div class="col-6 col-lg-2 pe-0 pe-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divOrderhistory" href="OrderHistory.aspx">Order <br class="d-none d-lg-block" />History</a></div>';
        ...
        html += '<div class="col-6 col-lg-2 ps-0 ps-lg-2"><a class="nav-link d-flex align-items-center justify-content-around text-center heading-semibold px-3 px-lg-4 border" id="divMemberProfile" href="ViewMemberProfile.aspx">My <br class="d-none d-lg-block" />Profile</a></div>';
