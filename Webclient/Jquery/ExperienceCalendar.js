(function (root, factory) {
    ...
    Calendar.prototype = {
        ...
        getDayAction: function (day) {
            var action = ITEM_DAY;
            if (this.selectedRang && typeof (this.selectedRang[0]) != 'undefined' && typeof (this.selectedRang[1]) != 'undefined') {
        ...
        setData: function (data) {
            this.data = data;
            this.selectedRang = [data[0]?.date, data[data.length > 0 ? data.length - 1 : 0]?.date];
            if (this.view === 'date') {
