        ...
        try
        {
            ...
            if (LobjTransactionDetails != null && LobjTransactionDetails.Count > 0)
            {
                ...
                foreach (TransactionDetails transactionDetails in LobjTransactionDetails)
                {
                    ...
                    sb.Append("<h2 class='h6 heading-bold d-flex align-items-center'><span class='heading-bold text-colour1'>NPR</span><span class='heading-bold text-colour7 pl-1'>"+ transactionDetails.Amounts + "</span></h2>");
