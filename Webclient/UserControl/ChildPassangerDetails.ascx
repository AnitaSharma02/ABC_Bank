...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RequiredFieldValidator ID="rfvAdultFirstName" runat="server" ControlToValidate="txtFirstName"
            ErrorMessage="Enter First Name" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger" Display="Dynamic" data-i18n="flightpassenger-error-enter-firstname"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="revAdultFirstName" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" ErrorMessage="Please Enter valid First Name." data-i18n="flightpassenger-error-enter-correctfirstname"></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RequiredFieldValidator ID="rfvAdultLastName" runat="server" ControlToValidate="txtLastName"
            ErrorMessage="Enter Last Name" data-i18n="flightpassenger-error-enter-lastname" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger" Display="Dynamic"></asp:RequiredFieldValidator>
        <asp:RegularExpressionValidator ID="revAdultLastName" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" data-i18n="flightpassenger-error-enter-correctlastname" ErrorMessage="Please Enter valid Last Name."></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RequiredFieldValidator ID="rfvAdultDOB" runat="server" ControlToValidate="txtDOB"
            Display="Dynamic" ErrorMessage="Enter Date of Birth" data-i18n="flightpassenger-error-enter-date" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"></asp:RequiredFieldValidator>
        <asp:CustomValidator ID="customChildDOBValidator" runat="server" ErrorMessage="Child  (2-12 yrs)"
            Display="Dynamic" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger" data-i18n="flightpassenger-error-enter-adults"
...
<div class="row">
    <div class="col-md-6 mb-3">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPassportNo"
            Display="Dynamic" data-i18n="flightpassenger-error-passport" ErrorMessage="Enter Passport Number" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"></asp:RequiredFieldValidator>
...
ErrorMessage="Minimum 6 characters required." data-i18n="flightpassenger-error-correct-passportLength"></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RegularExpressionValidator ID="revAdultEmail" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" ValidationGroup="WebValidation" data-i18n="flightpassenger-error-valid-emailid" ErrorMessage="Enter Valid E-mail Id">
    ...
    <div class="row">
        <div class="col-md-6 mb-3" id="divNationality" runat="server">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpNationality"
                Display="Dynamic" ErrorMessage="Enter Nationality" data-i18n="flightpassenger-error-nationality" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"
        ...
        <div class="col-md-6 mb-3" id="divPassportPlace" runat="server">
            ...
            <asp:RegularExpressionValidator ID="REVtxtPassportIssueLocation" Display="Dynamic" runat="server"
                ...
                CssClass="rptErrorMassage text-danger" ErrorMessage="Please Enter valid Place." data-i18n="hotel-booking-errorvalidpassportLocation"></asp:RegularExpressionValidator>
        ...
        <div class="col-md-6 mb-3" id="divTelephone" runat="server">
            ...
            <div class="invalid-feedback" id="ErrTelephone" runat="server">
                ...
                <asp:RegularExpressionValidator ID="revAdulttelephone" runat="server" Display="Dynamic"
                    ...
                    CssClass="rptErrorMassage text-danger" ErrorMessage="Enter Valid Number.(max 12 digit.)" data-i18n="hotel-booking-erroronlydigit"
                    Enabled="false">
                </asp:RegularExpressionValidator>
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="rfvAdultEffectiveDate" runat="server" ControlToValidate="txtEffectiveDate"
                Display="Dynamic" ErrorMessage="Enter Date of Issuance" data-i18n="flightpassenger-error-passsport-issue" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"
                Enabled="false"></asp:RequiredFieldValidator>
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:RequiredFieldValidator ID="rfvAdultExpiryDate" runat="server" ControlToValidate="txtExpiryDate"
                Display="Dynamic" ErrorMessage="Enter Expiry Date" data-i18n="flightpassenger-error-passsport-expiry" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"
                Enabled="false"></asp:RequiredFieldValidator>
