...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RegularExpressionValidator ID="revAdultFirstName" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" ErrorMessage="Please Enter valid First Name." data-i18n="hotel-booking-errorvalidfname"></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RegularExpressionValidator ID="revAdultLastName" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" ErrorMessage="Please Enter valid Last Name." data-i18n="hotel-booking-errorvalidlname"></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtPassportNo" Display="Dynamic"
            data-i18n="flightpassenger-error-passport" ErrorMessage="Enter Passport Number" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"></asp:RequiredFieldValidator>
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3" id="divPassportissue" runat="server">
            ...
            <asp:CustomValidator ID="customIssueDateValidator" ValidationGroup="WebValidation"
                runat="server" ErrorMessage="Issue date must be greater than DOB" data-i18n="flightpassenger-issue-date-greater" CssClass="rptErrorMassage text-danger"
        ...
        <div class="col-md-6 mb-3" id="divPassportexpiry" runat="server">
            ...
            <asp:CustomValidator ID="CustomExpiryDate" ValidationGroup="WebValidation" runat="server"
                ErrorMessage="Expiry date must be greater than issue date" data-i18n="flightpassenger-expirty-date-greater" CssClass="rptErrorMassage text-danger"
