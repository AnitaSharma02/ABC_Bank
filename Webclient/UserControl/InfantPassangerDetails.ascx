...
<div class="row">
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RegularExpressionValidator ID="revAdultFirstName" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" data-i18n="flightpassenger-error-enter-correctfirstname" ErrorMessage="Please Enter valid First Name."></asp:RegularExpressionValidator>
...
ErrorMessage="Minimum 6 characters required." data-i18n="flightpassenger-error-correct-passportLength"></asp:RegularExpressionValidator>
    ...
    <div class="col-md-6 mb-3">
        ...
        <asp:RegularExpressionValidator ID="revAdultEmail" Display="Dynamic" runat="server"
            ...
            CssClass="rptErrorMassage text-danger" data-i18n="flightpassenger-error-valid-emailid" ErrorMessage="Enter Valid E-mail Id">
    ...
    <div class="row">
        <div class="col-md-6 mb-3" id="divNationality" runat="server">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="drpNationality"
                Display="Dynamic" data-i18n="flightpassenger-error-nationality" ErrorMessage="Enter Nationality" ValidationGroup="WebValidation" CssClass="rptErrorMassage text-danger"
        ...
        <div class="col-md-6 mb-3" id="divTelephone" runat="server">
            ...
            <div class="invalid-feedback" id="ErrTelephone" runat="server">
                ...
                <asp:RegularExpressionValidator ID="revAdulttelephone" runat="server" Display="Dynamic"
                    ...
                    CssClass="rptErrorMassage text-danger" data-i18n="flightpassenger-error-valid-mobile" ErrorMessage="Enter Valid Number.(max 12 digit.)"
                    Enabled="false">
                </asp:RegularExpressionValidator>
            </div>
        ...
        <div class="col-md-6 mb-3" id="divPassportissue" runat="server">
            ...
            <asp:CustomValidator ID="customIssueDateValidator" ValidationGroup="WebValidation"
                runat="server" data-i18n="flightpassenger-error-passsport-issue-date" ErrorMessage="Issue date must be greater than DOB" CssClass="rptErrorMassage text-danger"
        ...
        <div class="col-md-6 mb-3">
            ...
            <asp:CustomValidator ID="CustomExpiryDate" ValidationGroup="WebValidation" runat="server"
                data-i18n="flightpassenger-error-passsport-expiry-date" ErrorMessage="Expiry date must be greater than issue date" CssClass="rptErrorMassage text-danger"
