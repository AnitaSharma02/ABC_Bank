    ...
    <div class="row">
        ...
        <div class="col-sm-4 col-12 mb-3">
            ...
            <asp:RegularExpressionValidator ID="revAdultFirstName" Display="Dynamic" runat="server"
                ...
                CssClass="text-danger" ErrorMessage="Please Enter valid First Name." data-i18n="hotel-booking-errorvalidfname"></asp:RegularExpressionValidator>
        </div>
        <div class="col-sm-4 col-12 mb-3">
            ...
            <asp:RequiredFieldValidator ID="rfvAdultLastName" runat="server" ControlToValidate="txtLastName"
             ...
             <asp:RegularExpressionValidator ID="revAdultLastName" Display="Dynamic" runat="server"
                ...
                CssClass="text-danger" ErrorMessage="Please Enter valid Last Name." data-i18n="hotel-booking-errorvalidlname"></asp:RegularExpressionValidator> 
        </div>
     </div>
