...
public partial class SourceControl_InfantPassangerDetails : System.Web.UI.UserControl
{
    ...
    protected void IssueInfantDateValidator(object source, ServerValidateEventArgs args)
    {
        if (!string.IsNullOrEmpty(args.Value))
        {
            args.IsValid = validateInfantAge(args);
        }
    }

    private bool validateInfantAge(ServerValidateEventArgs args)
    {
