                                ...
                                <div class="bg-colour2 p-3">
                                     <div class="row">
                                        ...
                                        <div class="col-12 order-5 order-lg-6">
                                            <div class="row">
                                                <div class="col-6 col-sm-6 col-lg-3 mb-3 mb-lg-0" id="Room1" >
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3 mb-3 mb-lg-0" id="Room2" style="display: none;" >
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3 mb-3 mb-lg-0" id="Room3" style="display: none;" >
                                                    <div class="dvDropdown dropdown">
                                                        <button class="h7 btn text-capitalize dropdown-toggle bg-transparent border-0 p-0 text-colour6" type="button" data-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <div class="col-6 col-sm-6 col-lg-3 mb-3 mb-lg-0" id="Room4" style="display: none;" >
                                                    <div class="dvDropdown dropdown text-right text-sm-left">
                                                        <button class="h7 btn text-capitalize dropdown-toggle bg-transparent border-0 p-0 text-colour6" type="button" data-toggle="dropdown" aria-expanded="false">
        ...
        <div class="container-lg">
            <div class="row">
                <div class="col-12 text-center m-auto my-3">
                    <h2 class="h1 heading-light text-colour1 pb-4 px-3">Popular Hotels Around The Globe</h2>
                </div>
            </div>
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3" onclick="SelectDestinationToInSearchOption('SG,Singapore,Singapore');">
                    <a href="#hotelscrollupAnchor" rel="" id="hotelAnchorSG" class="d-block shadow-sm">
                        <div class="bg-white border d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap bg-white px-3 pt-3">
                                <h2 class="h6 heading-bold text-truncate col-12 mb-2">leonardo</h2>
                                <h2 class="h7 heading-regular col-12 mb-1 product-text">Seminyak-Beach-Denpasar, -BA, Indonesia
                                </h2>
                                <div class="mb-3">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3" onclick="SelectDestinationToInSearchOption('TH,Thailand,Bangkok');">
                    <a href="#hotelscrollupAnchor" rel="" id="hotelAnchorTH" class="d-block shadow-sm">
                        <div class="bg-white border d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap bg-white px-3 pt-3">
                                <h2 class="h6 heading-bold text-truncate col-12 mb-2">The-Hoxton</h2>
                                <h2 class="h7 heading-regular col-12 mb-1 product-text">Rome, Italy
                                </h2>
                                <div class="mb-3">
                                    <img src="images/icons/other/star-fill.svg" alt="">
                                    <img src="images/icons/other/star-fill.svg" alt="">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3" onclick="SelectDestinationToInSearchOption('FR,France,Paris');">
                    <a href="#hotelscrollupAnchor" rel="" id="hotelAnchorFR" class="d-block shadow-sm">
                        <div class="bg-white border d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap bg-white px-3 pt-3">
                                <h2 class="h6 heading-bold text-truncate col-12 mb-2">The-Singular-Patagonia</h2>
                                <h2 class="h7 heading-regular col-12 mb-1 product-text">Puerto-Natales
                                </h2>
                                <div class="mb-3">
                                    <img src="images/icons/other/star-fill.svg" alt="">
                                    <img src="images/icons/other/star-fill.svg" alt="">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-3" onclick="SelectDestinationToInSearchOption('NZ,New Zealand,Christchurch');">
                    <a href="#hotelscrollupAnchor" rel="" id="hotelAnchorNZ" class="d-block shadow-sm">
                        <div class="bg-white border d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap bg-white px-3 pt-3">
                                <h2 class="h6 heading-bold text-truncate col-12 mb-2">Taj falaknuma palace</h2>
                                <h2 class="h7 heading-regular col-12 mb-1 product-text">Hyderabad, India
                                </h2>
                                <div class="mb-3">
                                    <img src="images/icons/other/star-fill.svg" alt="">
                                    <img src="images/icons/other/star-fill.svg" alt="">
