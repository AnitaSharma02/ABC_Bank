            ...
            function fnBindSearchItem(data) {
                ...
                if (data != '') {
                    ...
                    $.each(parseData.data, function (i) {
                        ...
                        html += "<p class=\"points\"><span>from</span> <span>" + FormatCurrency(parseFloat(parseData.data[i].convertedAmount).toFixed(2), parseData.data[i].convertedCurrency) + "</span>/pax<span></span></p>";
                        html += "</div>";
                        html += "</a>";
                        html += "</div>";
                        html += "</div>";
